...
translations = {
    'ru': {
        ...
        'create_forecast_text': "В настоящее время прогнозы доступны для криптовалют. Прогнозы по акциям и NFT находятся в разработке.",
        'select_crypto_button': "🪙 Криптовалюта",
        'stocks_in_dev_button': "📈 Акции",
        'nft_in_dev_button': "🖼️ NFT",
        'in_dev_alert': "Эта функция находится в разработке.",
        'select_crypto_text': "Выберите криптовалюту с помощью кнопок ниже или введите ее в чат в формате 'BTCUSDT' (регистр не важен).",
        'invalid_symbol_text': "Неверный символ. Пожалуйста, попробуйте еще раз или выберите из списка.",
        'page_button_text': "Страница {current_page}/{total_pages}",
